...
class Client{
	public:
		Client(std::string head_addr, std::string port, size_t queueSize):
			head_addr_(head_addr), port_(port), shutdown_(false), connected_(false), total_queue_size_(queueSize), client_order_(0),pubQue_(total_queue_size_){
