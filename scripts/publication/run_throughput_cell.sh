...
CLIENT_ORDER5_BROKER_ALLOWLISTS_PIPE='${CLIENT_ORDER5_BROKER_ALLOWLISTS_PIPE:-}' \\
...
order5_client_allowlists=${CLIENT_ORDER5_BROKER_ALLOWLISTS_PIPE:-}
min_overlap_ms=${MIN_OVERLAP_MS:-}
skip_cluster_setup=${SKIP_CLUSTER_SETUP:-}
commit=$COMMIT
