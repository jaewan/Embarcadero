# Historical launcher notes

Preserved from the pre-consolidation scripts README for interpreting older commands and results. These notes include obsolete hardware assumptions and unverified or superseded behavior, including ACK/replication combinations. They are not current operating instructions or release qualification. Use [the supported launcher guide](README.md), [support matrix](../docs/support-matrix.md), and retained run manifests for current scope.
