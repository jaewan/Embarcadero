...
start_brokers() {
    ...
    if [[ -n "${EMBARCADERO_ORDER5_BYPASS_SESSION_FIFO_ABLATION:-}" ]]; then
        export EMBARCADERO_ORDER5_BYPASS_SESSION_FIFO_ABLATION
    fi
...
if [ -n "${EMBARCADERO_ORDER5_BYPASS_SESSION_FIFO_ABLATION:-}" ]; then export EMBARCADERO_ORDER5_BYPASS_SESSION_FIFO_ABLATION=${EMBARCADERO_ORDER5_BYPASS_SESSION_FIFO_ABLATION:-}; fi
