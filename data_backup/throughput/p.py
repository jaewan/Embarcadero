...
def process_file(file_path):
    ...
    grouped['E2E'] = grouped['E2E'] / 1000.0
    return grouped.index, grouped['E2E']
...
ax.set_title('Average Publish Rate vs Message Size', fontsize=20, fontweight='bold', pad=20)
ax.set_xlabel('Message Size (Bytes)', fontsize=16, fontweight='bold', labelpad=10)
ax.set_ylabel('Average Publish Rate (GB/sec)', fontsize=16, fontweight='bold', labelpad=10)
...
plt.savefig('E2E_throughput.png', dpi=300, bbox_inches='tight')
